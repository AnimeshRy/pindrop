...
/**
 * The single-report view: one scan's findings, with no history.
 *
 * This is what `pindrop serve --results report.json` shows, and it is the page
 * the dashboard was before scan history existed. It is kept intact rather than
 * folded into the run-detail view, because that view needs a repository and a
 * run, and a bare report file has neither.
 */
